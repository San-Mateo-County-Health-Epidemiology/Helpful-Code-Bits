...
## 2. Open C:/Users/<username>/AppData/Local/Microsoft/FontCache/4/CloudFonts and find Trade Gothic Next Rounded. 
...
## 4. In the folder there should be at least one .ttf file. Manually rename one of the .ttf files to "TradeGothicNextRounded" (this is the string you'll search for in the `font_import(pattern = "")`).
